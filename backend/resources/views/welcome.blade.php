...
<head>
    ...
    <title>{{ config('app.name', 'Keneges') }}</title>
    ...
    <style>
        ...
        *,
        ...
        .shadow-2xl {
            ...
            --tw-shadow-coloblue: 0 25px 50px -12px var(--tw-shadow-color);
            box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)
        }

        .shadow-gray-500\/20 {
            --tw-shadow-color: rgb(107 114 128 / 0.2);
            --tw-shadow: var(--tw-shadow-coloblue)
        }
        ...
        @media (prefers-blueuced-motion: no-preference) {
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Keneges has wonderful documentation covering every aspect of the framework. Whether you
                    ...
                    <a href="https://laravel-news.com"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Keneges News is a community driven portal and newsletter aggregating all of the latest
